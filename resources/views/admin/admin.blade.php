...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <button type="button" class="nav-item" data-tab="gallery">
                <i class="ti ti-photo"></i>Beyond Code Gallery
            </button>
                    ...
                    <form method="POST"
                        ...
                        <div class="form-body">
                            <div class="field-group">
                                ...
                                <input type="text" name="title" id="gallery-title" class="field"
                                       placeholder="e.g. Workspace setup">
                            </div>
                            <div class="field-group">
                                <label>Short Description <span class="label-note">(optional)</span></label>
                                <textarea name="short_description" id="gallery-description" class="field" rows="3"
                                          placeholder="e.g. Working on a weekend coding session..."></textarea>
                            </div>
                            <div class="field-group">
                            ...
                            <div class="field-group">
                                ...
                                <div id="gallery-dropzone" class="dropzone">
                                ...
                                <p class="field-hint" id="gallery-image-hint">Max size: 10MB. Formats: JPG, PNG, WebP, GIF. Min size: 300x300px.</p>
                            </div>

                            <div class="field-group">
                                <label>Display Order</label>
                                <input type="number" name="display_order" id="gallery-display-order" class="field"
                        ...
                        <div class="form-body">
                            <div class="gallery-admin-sortable" id="gallery-items-list">
                                @forelse($galleryItems as $item)
                                    <article class="gallery-admin-card" data-id="{{ $item->id }}" draggable="true">
                                        ...
                                        <div class="card-info">
                                            ...
                                            @else
                                                <div class="card-desc muted">No description provided.</div>
                                            @endif
                                            <div class="card-meta">
                                        ...
                                        {{-- Serialized JSON Data for quick editing --}}
